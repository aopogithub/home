...
docker tag registry.aliyuncs.com/google_containers/coredns:latest k8s.gcr.io/coredns/$coredns_version
...
docker image rm registry.aliyuncs.com/google_containers/coredns:latest
